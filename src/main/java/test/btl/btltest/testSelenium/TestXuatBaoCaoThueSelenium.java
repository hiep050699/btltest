...
public class TestXuatBaoCaoThueSelenium {
    ...
    public void start() throws InterruptedException {
        System.setProperty("webdriver.edge.driver","C:\\Users\\User\\Desktop\\nam4\\kiemtra chat luong pm\\msedgedriver.exe");
    ...
    //Kiểm tra xuất báo cáo thống kê thực hiện đủ các bước, theo năm nhập sai định dạng
    @Test
    ...
    //Kiểm tra xuất báo cáo thống kê thực hiện đủ các bước, theo tháng không nhập 
    @Test
